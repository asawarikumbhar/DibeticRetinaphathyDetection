...
export default function Home() {
  return (
   <>
   <div className="max-w-4xl mx-auto px-2 py-8 ml-24">
      ...
      {/* symptoms */}
        ...
        {/* <img src={require("../images/symptom1.png")}  alt="Image 1" className="w-full" />
      
        <img src={require("../images/symptom2.png")}  alt="Image 2" className="w-full" />

        <img src={require("../images/symptom3.png")}  alt="Image 3" className="w-full" />
      
        <img src={require("../images/symptom4.png")}  alt="Image 4" className="w-full" />
     
        <img src={require("../images/symptom5.png")}  alt="Image 5" className="w-full" /> */}
     <div>
      <p className="ml-20">The symptoms of Diabetic Retinopathy in the early stages,diabetic retinopathty may not cause any noticeable symptoms.As the condition progresse,symptoms may include:</p>
     </div>
